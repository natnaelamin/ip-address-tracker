...
export default function Home() {
  return (
    <div className="relative ">
      ...
      <div className="absolute top-[230px] w-full h-full px-5 md:h-[150px] flex justify-center items-center ">
        <div className="grid md:grid-cols-4 md:place-items-center w-full md:w-[1000px] h-full bg-amber-300  px-10 rounded-xl">
          <div className="grid gap-4 md:border-r border-r-slate-500 pr-14 h-14 md:h-20">
            ...
            <h1 className="font-extrabold text-lg md:text-xl">192.212.174.101</h1>
          </div>
          <div className="grid gap-1 md:border-r border-r-slate-500 pr-14 h-14 md:h-20">
            ...
            <h1 className="font-extrabold text-lg md:text-xl">BROOKLYN, NY 10001</h1>
          </div>
          <div className="grid gap-1 md:border-r border-r-slate-500 pr-14 h-14 md:h-20">
            <h4 className="text-zinc-500 font-semibold text-sm">TIME ZONE</h4>
            <h1 className="font-extrabold text-lg md:text-xl">UTC-05:00</h1>
          </div>
          <div className="grid gap-1 pr-14 h-14 md:h-20">
            <h4 className="text-zinc-500 font-semibold text-sm">ISP</h4>
            <h1 className="font-extrabold text-lg md:text-xl">SpaceX Starlink</h1>
          </div>
        </div>
      </div>
